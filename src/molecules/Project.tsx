...
const Project = (props: ProjectProps) => {
    return (
        <div
            className={`flex group hover:cursor-pointer flex-col lg:flex-row lg:gap-10 gap-4 p-4 border border-transparent transition-all ease-in-out transition-500 rounded-lg hover:bg-slate-200 hover:bg-opacity-[3%] hover:border-slate-600 hover:border-opacity-30`}
        >
            <section>
                <img 
